...
impl Memory {
    ...
    pub fn new_from_assembly(source_path: &str, link_path: &str, toolchain_prefix: &str, be: bool) -> Memory {
        ...
        Memory::new_from_file(&bytes, be)
    }

    pub fn new_from_file(elf_file: &Vec<u8>, be: bool) -> Memory {
